...
- [Threat Intelligence & Feeds](./threat-intelligence.md) — the KEV, OTX, and URLhaus feeds that power exploit-aware prioritization.
- [Vulnerability Management](../vulnerability-risk/vulnerability-management/index.mdx) — triage, risk scoring, and tracking findings to remediation.
- [Risk Register](../vulnerability-risk/risk-management/index.md) — promote significant findings into the risk register with treatment plans.
