...
| **Vulnerabilities & findings** | Pull the unified findings queue, filter by severity/status/source, push updates to another system. See **[Vulnerability Management](../vulnerability-risk/vulnerability-management/index.mdx)**. |
