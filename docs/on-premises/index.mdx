...
<DocFaq items={[
  {
    ...
    a: "Offload Security runs fully on-premises or air-gapped, covering cloud, code, container and Kubernetes posture plus internal-network discovery, OpenVAS vulnerability scanning and Wazuh telemetry — all in one dashboard. Most SaaS-only CNAPPs cannot be self-hosted.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes. It discovers internal assets, scans private applications and APIs, runs vulnerability scans against internal hosts via OpenVAS, and ingests endpoint and SIEM telemetry from Wazuh — correlated alongside cloud and container posture.",
  },
  {
