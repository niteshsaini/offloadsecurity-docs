...
<DocFaq items={[
  ...
  {
    q: "Can Offload ingest findings from tools like Qualys, Tenable, Snyk or Wazuh?",
    a: "Yes. Third-party scanner findings are streamed into the same vendor-neutral data lake and surface in the single deduplicated, risk-scored Vulnerability Dashboard alongside Offload's own findings.",
  },
]} />
